...
const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center rounded-md font-medium whitespace-nowrap bg-none border-none p-0 m-0 text-inherit font-inherit cursor-pointer outline-none",
  {
    variants: {
      var: {
